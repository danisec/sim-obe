    ...
    <x-molecules.breadcrumb>
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="tetx-sm mx-2 font-medium text-gray-500 md:text-base">Mapping Cpl</span>
            </div>
        </li>
    </x-molecules.breadcrumb>

    <div class="my-8">
        <h4 class="mb-6 text-xl font-semibold text-gray-900 md:text-2xl">Data Mapping CPL Mata Kuliah</h4>
