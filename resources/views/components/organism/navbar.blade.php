<header class="z-10 bg-white py-4">
    <div class="mx-auto flex h-full items-center justify-between px-6 text-gray-900 md:justify-end">

        <!-- Mobile hamburger -->
        <button class="focus:shadow-outline-purple -ml-1 mr-5 rounded-md p-1 focus:outline-none md:hidden"
            aria-label="Menu" @click="isSideMenuOpen = !isSideMenuOpen">
            ...
            <div class="flex flex-row items-center gap-2.5">
                ...
                <div x-data="{ isOpen: false }">
                    <button type="button" @click="isOpen = !isOpen" @keydown.escape="isOpen = false">
                        <svg class="mt-1 h-8 w-8 md:h-10 md:w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
